...
function rara_academic_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_panel(
        ...
        'rara_academic_typography_section',
        array(
            'title' => __( 'Typography Settings', 'rara-academic' ),
            'priority' => 80,
        )
    );
    ...
    $wp_customize->add_control(
        'ed_localgoogle_fonts',
        array(
            'label'   => __( 'Load Google Fonts Locally', 'rara-academic' ),
            'section' => 'rara_academic_typography_section',
            'type'    => 'checkbox',
        )
    );
    ...
    $wp_customize->add_control(
        'ed_preload_local_fonts',
        array(
            'label'           => __( 'Preload Local Fonts', 'rara-academic' ),
            'section'         => 'rara_academic_typography_section',
            'type'            => 'checkbox',
            'active_callback' => 'rara_academic_flush_fonts_callback'
        )
    );
    ...
    $wp_customize->add_control(
        'flush_google_fonts',
        array(
            'label'       => __( 'Flush Local Fonts Cache', 'rara-academic' ),
            'description' => __( 'Click the button to reset the local fonts cache.', 'rara-academic' ),
            'type'        => 'button',
            'settings'    => array(),
            'section'     => 'rara_academic_typography_section',
            'input_attrs' => array(
                'value' => __( 'Flush Local Fonts Cache', 'rara-academic' ),
    ...
    $wp_customize->get_section( 'rara_academic_typography_section' )->panel = 'wp_default_panel';
...
function rara_academic_flush_fonts_callback( $control ){
