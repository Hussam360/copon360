...
7. Save changes', 'rara-academic'),
    ...
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'View demo', 'rara-academic' ) . ': </label><a href="' . esc_url( 'https://rarathemes.com/previews/?theme=rara-academic' ) . '" target="_blank">' . __( 'here', 'rara-academic' ) . '</a></span><br />';
