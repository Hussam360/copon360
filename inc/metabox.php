...
function rara_academic_save_sidebar_layout( $post_id ){
      global $rara_academic_sidebar_layout;
    ...
    $layout = isset( $_POST['rara_academic_sidebar_layout'] ) ? sanitize_key( $_POST['rara_academic_sidebar_layout'] ) : 'default-sidebar';

    if( array_key_exists( $layout, $rara_academic_sidebar_layout ) ){
        update_post_meta( $post_id, 'rara_academic_sidebar_layout', $layout );
    }else{
        delete_post_meta( $post_id, 'rara_academic_sidebar_layout' );
    }
}
